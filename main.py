...
ÖNEMLİ GÖREV: Eğer kullanıcı senden açıkça bir görsel, resim, fotoğraf veya çizim oluşturmanı isterse, normal bir cevap verme.
...
Örnek: Kullanıcı "Kampüsün fotoğrafını oluştur" derse, sen `[GORSEL_OLUSTUR] A photorealistic image of Balikesir University vocational school campus, sunny day, modern buildings.` yazmalısın.
Diğer tüm durumlarda normal Türkçe metin olarak cevap ver.
"""
...
st.markdown("<p style='text-align: center; color: gray;'>Metin veya görsel oluşturma taleplerinizi yazın.</p>", unsafe_allow_html=True)
